...
execute if score @s unclear matches 0 run say @s is the winner!
...
execute if score @s unclear matches 0 run scoreboard objectives setdisplay sidebar Winner

scoreboard objectives remove unclear
