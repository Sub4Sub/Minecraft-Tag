...
execute as @a[x=-127, y=40, z=5080, dx=-236, dy=110, dz=5189] run tag add @s inMap
...
#execute as @a[tag=outMap] if score @s boundryTimer matches 200 run effect give @s minecraft:instant_damage 5 5
