...
execute as @a[tag=player] if score @s holdStillTimer matches 400 run effect give @s minecraft:glowing 10 1

execute as @a[tag=player] if score @s holdStillTimer matches 400 run scoreboard players set @s holdStillTimer 100
