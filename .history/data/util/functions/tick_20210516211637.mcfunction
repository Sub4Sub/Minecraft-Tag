...
execute as @a[tag=player] if score @s tagCurrentPosX = @s tagPrevPosX if score @s tagCurrentPosY = @s tagPrevPosY if score @s tagCurrentPosZ = @s tagPrevPosZ run scoreboard players add @s holdStillTimer 1
