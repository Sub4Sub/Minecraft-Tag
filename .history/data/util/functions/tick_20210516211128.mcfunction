...
execute as @a[tag=player] if score @s tagCurrentPosX =  tagPrevPosX if score @s tagCurrentPosY = @s tagPrevPosY if score @s tagCurrentPosZ =  tagPrevPosZ run scoreboard players add @s holdStillTimer 1

execute as @a[tag=player] if score @s tagCurrentPosY = @s tagPrevPosY run scoreboard players add @s holdStillTimer 1

execute as @a[tag=player] if score @s tagCurrentPosZ = @s tagPrevPosZ run scoreboard players add @s holdStillTimer 1
